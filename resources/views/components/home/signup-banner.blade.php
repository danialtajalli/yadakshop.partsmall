    ...
    <div class="relative w-full overflow-hidden bg-gradient-to-bl from-brand-dark via-brand to-[#2d3748]">
        ...
        <div class="ps-container relative z-10 py-10 sm:py-14">
            <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-10">
                ...
                <div class="shrink-0 md:flex md:items-center md:justify-center">
                    <a
                        href="{{ $signupUrl }}"
                        class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#f27c22] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_8px_24px_rgb(242_124_34_/_0.4)] transition hover:bg-[#e06d15] active:scale-[0.98] md:w-auto md:min-w-52 md:px-8 md:py-4 md:text-base"
                    >
                        همین حالا ثبت‌نام کنید
                        <svg class="size-4 md:size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
